...
<div id="wrap" >
		...
		<section class='sec1'>
			...
			<nav class='lnb' style="text-align: center;">
				<ul >
					<li><a href='#' onclick="location.href='LoginController.do?command=login'" style="color:#fff; font-size:40px;">공지글 수정</a></li>
				</ul>
			</nav>
...
<table class="list-table">
	...
	<tr>
		<td colspan="2">
			...
			<button type="button" onclick="location.href='NotController.do?command=boardlistpage&pnum=1'">글목록</button>
		</td>
	</tr>
</table>
</form>
