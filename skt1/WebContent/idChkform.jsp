...
//현재페이지를 열어준 부모페이지.문서에서.name속성의값이 id인 엘리먼트를 구해서 .입력값을 얻어옴
...
<body>
<%
	LoginDto dto=(LoginDto)request.getAttribute("ldto");
	boolean isS=false;
	if(dto==null||dto.getId()==null){//사용가능하다면
		isS=true;
	}
%>
<table border="1">
